...
*
***/
var checkUserPermissions = function(request, userClient, cb){
  ...
  if (request._tokendata.isserver) {
    ...
    // TODO: 20150715_darinkrauss [SECURITY] We aren't actually checking to
    // see if the user has permissions to obtain the other's meta pair.
    /*
...
module.exports = function(userClient) {
  return function(req, res, next) {
    ...
    checkUserPermissions(req, userClient, function(permissionsError,userid){
