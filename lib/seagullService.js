...
function createServer(serverConfig, userApiConfig, crudHandler, userApiHostGetter) {
  ...
  server.post('/:userid/:collection', checkToken, getMeta, seagullApi.metaroot);
  server.get('/:userid/:collection', checkToken, getMeta, seagullApi.metaroot);
  server.put('/:userid/:collection', checkToken, getMeta, seagullApi.metaroot);
  server.del('/:userid/:collection', checkToken, getMeta, seagullApi.metaroot);
