...
function createServer(serverConfig, crudHandler, userApiClient, armadaClient, metrics) {
...
module.exports = function seagullService(envConfig, crudHandler, userApiClient, armadaClient, metrics) {
  var server = null;
