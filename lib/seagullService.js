...
function createServer(serverConfig, crudHandler, userApiClient, metrics, gatekeeperApiClient) {
  ...
  var seagullApi = require('./routes/seagullApi')(crudHandler, userApiClient, metrics, gatekeeperApiClient);
...
module.exports = function seagullService(envConfig, crudHandler, userApiClient, metrics, gatekeeperApiClient) {
  var server = null;
