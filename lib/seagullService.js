...
function createServer(serverConfig, crudHandler, userApiClient, metrics, gatekeeperClient) {
  ...
  var seagullApi = require('./routes/seagullApi')(crudHandler, userApiClient, metrics, gatekeeperClient);
...
module.exports = function seagullService(envConfig, crudHandler, userApiClient, metrics, gatekeeperClient) {
  var server = null;
