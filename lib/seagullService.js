...
function createServer(serverConfig, userApiConfig, crudHandler, userApiHostGetter) {
  ...
  server.post('/group/:userid/:collection', checkToken, getMeta, seagullApi.metagroup_create);
  server.get('/group/:userid/:collection', checkToken, getMeta, seagullApi.metagroup_read);
  server.put('/group/:userid/:collection', checkToken, getMeta, seagullApi.metagroup_updateOrDelete);
  server.del('/group/:userid/:collection', checkToken, getMeta, seagullApi.metagroup_updateOrDelete);

  // manage the private information
  server.post('/private/:userid/:collection', checkToken, getMeta, seagullApi.metaprivate_create);
  server.get('/private/:userid/:collection', checkToken, getMeta, seagullApi.metaprivate_read);
  server.put('/private/:userid/:collection', checkToken, getMeta, seagullApi.metaprivate_updateOrDelete);
  server.del('/private/:userid/:collection', checkToken, getMeta, seagullApi.metaprivate_updateOrDelete);
