...
function createServer(serverConfig, crudHandler, userApiClient, gatekeeperClient, metrics) {
  ...
  retVal.get('/:userid/private/:name', checkToken, permissions.requireServer, seagullApi.metaprivate_read);
  retVal.del('/:userid/private/:name', checkToken, permissions.requireServer, seagullApi.metaprivate_delete);
  ...
  retVal.post('/:userid/:collection', checkToken, permissions.requireCustodian, seagullApi.metacollection_update);
  retVal.get('/:userid/:collection', checkToken, permissions.requireMembership, seagullApi.metacollection_read);
  retVal.put('/:userid/:collection', checkToken, permissions.requireCustodian, seagullApi.metacollection_update);
  retVal.del('/:userid/:collection', checkToken, permissions.requireCustodian, seagullApi.metacollection_delete);
